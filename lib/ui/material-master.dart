          ...
          child: Column(
            children: [
                ...
                onPressed: ()async{
                  if(_name.text.trim().length<1){
                    ...
                    if(!_isAddedPressed){
                      ...
                      await FirebaseFirestore.instance.collection("materialMaster").add({
                        "name":_name.text
                      }).whenComplete(() {
                      ...
                      Fluttertoast.showToast(msg: "Please wait. Adding Material");
                    }
                  }
                },
              ),
              ...
              StreamBuilder<QuerySnapshot>(
                stream: FirebaseFirestore.instance.collection("materialMaster").snapshots(),
    ...
    return Row(
      ...
      children: [
        ...
        Container(
            ...
            child: Text("Material Name",style: TextStyle(fontWeight: FontWeight.w800),)
        ),
        // Container(
        //     width: MediaQuery.of(context).size.width*4/10,
        //     padding: EdgeInsets.only(left: 20,right: 20,top: 5,bottom: 5),
      ...
      children: [
        Container(
            ...
            child: IconButton(
              ...
              onPressed: (){
                FirebaseFirestore.instance.collection("materialMaster").doc(sno).delete().whenComplete(() {
                  Fluttertoast.showToast(msg: "Material Deleted");
                });
              },
            )
        ),
